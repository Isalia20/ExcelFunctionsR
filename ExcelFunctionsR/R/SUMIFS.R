...
#' @param criteria_range1,criteria_range2,criteria_range3,criteria_range4,criteria_range5,criteria_range6,criteria_range7,criteria_range8,criteria_range9,criteria_range10 Which range should it check the criteria against. Only criteria_range1 is mandatory, others are optional.
#' @param criteria1,criteria2,criteria3,criteria4,criteria5,criteria6,criteria7,criteria8,criteria9,criteria10 what criteria should it check in range. Only criteria1 is mandatory, others are optional.
#' @import base
#' @import stringr
#' @export
#' @examples
#' SUMIFS(iris$Petal.Length,iris$Species,"setosa",iris$Petal.Width,0.2)
#' @return In this example we sum the petal length of all setosa species which have petal width of 0.2. Function will always return numeric class.



SUMIFS <-
function(sum_range,criteria_range1 , criteria1, criteria_range2 = TRUE ,criteria2 = TRUE,
