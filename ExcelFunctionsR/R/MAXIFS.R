...
#'
#' @param max_range Range from where it should return the maximum value from.
...
#' @return This example returns maximum value of Petal Length of species setosa who have petal width 0.2. Function will always return numeric class.

MAXIFS <-
function(max_range,criteria_range1 , criteria1, criteria_range2 = TRUE ,criteria2 = TRUE,
  ...
  ret <- max(max_range[c(get(c1)(criteria_range1,criteria1))&
